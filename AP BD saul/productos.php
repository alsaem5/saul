...
<body>
    ...
    <form action="registroproducto.php" method="POST">
        ...
        </div><select class="form-select" aria-label="Default select example" name="codigo_fabricante">
                <?php
                include('conec.php');//*conexion de la bd
        ...
        <input type="submit" name="enviar" value="HOLA" class="btn btn-primary">
